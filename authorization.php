...
<body>
    ...
    <section class="authorization-box">
        ...
        <div class="authorization-box_main">
            <h1 class="authorization-box_title">Авторизация</h1>
            ...
            <form action="php/handler/obr_auth.php" method="post" class="authorization-box_form" id="forma_a">
                ...
                <div class="g-recaptcha" data-sitekey="6LeBxtMmAAAAAHY7ImyB9QdLYe9a50OFjZySI865" style=" display: flex; justify-content: center; margin-top: 25px;"></div>
                <div class="authorization-box_buttonbox">
                    ...
                    <a href="index.php" class="authorization-box_back-link">
